...
const sampleEvents = [
  {
    ...
    clock: "후반 63:30",
    score: [1, 1],
    subtitle: "공 소유 선수의 짧은 전진 + 패스 후보 바둑알",
    commentary: "AM-10이 공을 발밑에 붙인 채 반 박자 전진합니다. 좌우 패스 후보가 작은 라벨로 열립니다.",
    routePath: "M50.6 31 C51.2 30.8 51.9 30.6 52.9 30.8",
    ballFrom: [50.6, 51.4],
    ballTo: [52.9, 50.8],
    motion: {
      kind: "carry",
    ...
    actors: [
      { playerId: "home-am10", role: "공 소유", x: 52.9, y: 50.8, from: [50.6, 51.4], core: true, cardAnchor: "top", duration: 1240 },
      { playerId: "away-dm8", role: "압박 수비", x: 55.4, y: 47.6, core: false },
      { playerId: "home-st9", role: "침투", x: 62, y: 43, option: true },
      { playerId: "home-wm7", role: "측면", x: 48, y: 68, option: true },
    ],
  },
  {
    id: "tackle",
    ...
    actors: [
      { playerId: "home-am10", role: "공 소유", x: 47, y: 52, core: true, cardAnchor: "top" },
      { playerId: "away-dm8", role: "태클 시도", x: 55, y: 52, core: true, defenderCard: true, cardAnchor: "bottom" },
    ],
  },
  {
    id: "pass",
    ...
    actors: [
      { playerId: "home-am10", role: "패스", x: 48, y: 53, core: true, cardAnchor: "bottom" },
      { playerId: "home-st9", role: "받을 선수", x: 69, y: 48, core: true, cardAnchor: "top" },
  ...
  },
  {
    ...
    routePath: "M59 44.4 C69 39.9 79 35.4 89 30.9",
    ballFrom: [59, 79],
    ballTo: [89, 55],
    motion: {
      kind: "aerial",
    ...
    actors: [
      { playerId: "home-wm7", role: "크로스", x: 59, y: 79, core: true, cardAnchor: "top" },
      { playerId: "home-st9", role: "타깃", x: 84, y: 52, core: true, cardAnchor: "bottom" },
  ...
  },
  {
    ...
    routePath: "M31 34.9 C49 33.1 68 31.1 86 29.3",
    ballFrom: [31, 62],
    ballTo: [86, 52],
    motion: {
      kind: "aerial",
    ...
    actors: [
      { playerId: "home-cb4", role: "롱패스", x: 31, y: 62, core: true, cardAnchor: "bottom" },
      { playerId: "home-st9", role: "수신 후보", x: 86, y: 52, core: true, cardAnchor: "top" },
  ...
  },
  {
    ...
    actors: [
      { playerId: "home-st9", role: "슈팅", x: 78, y: 52, core: true, cardAnchor: "top" },
      { playerId: "away-cb5", role: "가까운 수비", x: 82, y: 45, core: false },
      { playerId: "away-gk", role: "골키퍼", x: 94, y: 50, core: true, keeper: true, defenderCard: true, cardAnchor: "bottom" },
    ],
  },
  {
    id: "goal",
    ...
    actors: [
      { playerId: "home-st9", role: "득점", x: 76, y: 53, core: true, cardAnchor: "top" },
      { playerId: "home-am10", role: "어시스트", x: 63, y: 62, core: true, cardAnchor: "bottom" },
      { playerId: "away-gk", role: "골키퍼", x: 94, y: 50, core: false, keeper: true },
    ],
  },
];
